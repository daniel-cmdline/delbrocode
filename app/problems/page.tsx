        ...
        <div className="w-full px-6 py-12">
          <div className="max-w-2xl mx-auto text-center">
            <div className="bg-red-900/20 border border-red-800 rounded-lg p-6 mb-6">
              <h2 className="text-xl font-semibold text-red-400 mb-2">🚨 Missing Database Configuration</h2>
              <p className="text-neutral-300 mb-4">{errorMessage}</p>
              
              <div className="text-left text-sm text-neutral-400 space-y-4">
                <div className="bg-gray-800/50 rounded-lg p-4">
                  <h3 className="font-semibold text-green-400 mb-2">⚡ 2-Minute Fix:</h3>
...
SUPABASE_SERVICE_ROLE_KEY=your-actual-service-key`}
                  ...
                  <p className="text-xs text-gray-400 mt-2">Get values from: Supabase Dashboard → Settings → API</p>
                </div>
                
                <div className="bg-yellow-900/20 border border-yellow-800 rounded-lg p-3">
                  <h4 className="font-semibold text-yellow-400 mb-1">📊 Database Setup:</h4>
            ...
            <div className="bg-blue-900/20 border border-blue-800 rounded-lg p-4">
              <h3 className="text-lg font-semibold text-blue-400 mb-2">🧪 Test Connection</h3>
